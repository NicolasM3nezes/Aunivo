...
export default function ContactPage(){
  const cards=[
    ...
    {Icon:MessageCircle,title:'WhatsApp',body:<a aria-label={`Falar com o Aunivo pelo WhatsApp ${LEGAL_CONTACT.whatsappDisplay}`} href={`https://wa.me/${LEGAL_CONTACT.whatsappNumber}`} target="_blank" rel="noopener noreferrer">{LEGAL_CONTACT.whatsappDisplay}</a>},
  ];
