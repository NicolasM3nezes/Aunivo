...
export default function ContactPage(){
  const cards=[
    {Icon:Mail,title:'Suporte',body:<TrackedContactLink contactMethod="email" href={`mailto:${LEGAL_CONTACT.supportEmail}`}>{LEGAL_CONTACT.supportEmail}</TrackedContactLink>},
    {Icon:Shield,title:'Privacidade e LGPD',body:<TrackedContactLink contactMethod="email" href={`mailto:${LEGAL_CONTACT.privacyEmail}`}>{LEGAL_CONTACT.privacyEmail}</TrackedContactLink>},
    {Icon:MessageCircle,title:'WhatsApp',body:<TrackedContactLink contactMethod="whatsapp" aria-label={`Falar com o Aunivo pelo WhatsApp ${LEGAL_CONTACT.whatsappDisplay}`} href={`https://wa.me/${LEGAL_CONTACT.whatsappNumber}`} target="_blank" rel="noopener noreferrer">{LEGAL_CONTACT.whatsappDisplay}</TrackedContactLink>},
  ];
